...
export class MaptestComponent implements OnInit {
  lat: number;//25.020777 緯度
  lng: number;//121.281521 經度
  zoomValue: number;// 預設縮放大小，zoom 的數值可從 0 到 21，也可以透過其他設定屬性，指定最小與最大值。
  ...
  constructor(private routeInfo: ActivatedRoute, private busService: BusService) {
  }
  ...
  mapReady(event: any) {
    this.zoomValue = 11
    this.lat = 24.923172156205972;
    this.lng = 121.2567947113057;
  }
